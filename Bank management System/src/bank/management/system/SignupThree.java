...
public class SignupThree extends JFrame implements ActionListener{
    ...
    SignupThree(String Formno){
        ...
        r1.setBounds(80,150,150,30);
        add(r1);
        
        r2.setBounds(330,150,300,30);
        add(r2);
        
        r3.setBounds(80,190,250,30);
        add(r3);
        
        r4.setBounds(330,190,250,30);
        add(r4);
        
        l3.setBounds(80,250,200,30);
        add(l3);
        
        l4.setBounds(330,250,250,30);
        add(l4);
        
        l5.setBounds(60,270,200,20);
        add(l5);
        
        l6.setBounds(280,270,500,20);
        add(l6);
        ...
        l9.setBounds(60,330,200,20);
        add(l9);
        
        l10.setBounds(80,370,200,30);
        add(l10);
